    ...
    >
      <div className="container relative">
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6.25rem]">
          ...
          <div className="relative max-w-[23rem] mx-auto mt-10 md:max-w-5xl xl:mb-24">
            ...
            <div className="absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[46%] md:w-[138%] lg:-top-[104%] -z-2">
              <img
                src={heroBackground}
                className="w-full"
                width={1440}
